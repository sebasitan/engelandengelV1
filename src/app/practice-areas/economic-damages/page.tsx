                ...
                >
                  <div className="space-y-8">
                    <div className="space-y-6">
                      <p className={`text-slate-600 leading-relaxed text-xl text-slate-700 font-medium`}>
            ...
            >
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-blue-50 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300 group">
                    ...
                    <span className="text-[1.05rem] font-medium text-slate-700 leading-snug group-hover:text-[#0f3574] transition-colors">{item}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
