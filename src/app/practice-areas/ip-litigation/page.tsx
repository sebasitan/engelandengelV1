            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              {sections.map((section, idx) => (
                <motion.div
                  ...
                  className={`group relative bg-white p-8 md:p-10 rounded-xl shadow-[0_10px_40px_-15px_rgba(0,0,0,0.08)] border border-[#0f3574] border-t-4 hover:shadow-[0_20px_60px_-20px_rgba(15,53,116,0.15)] transition-all duration-500 flex flex-col ${
                    section.id === 'overview' ? 'md:col-span-2' : ''
                  }`}
                >
                  <div className="mb-8">
